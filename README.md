...
## 배운점
>### 1. 심플한 홈페이지를 최대한 활용한 App의 장점 전달
> - App을 중점으로 두고있는 회사에서 사용하기에 가장 알맞은 형태는 심플하지만 App의 장점을 보여줄수 있는 그런 사이트가 아닐까 하고 생각하게 되었습니다.
>
>   App을 보조하는 사이트임을 생각할때 물론 App의 사용방법, App을 사용할때 얻는 부가적인 효과 <br> 혹은 기존 App들과 다른 점 등을 사이트에 녹여내는 것은 때에 따라 좋을수는 있습니다. <br>하지만 Colco처럼 App이 주목적인 사람들은 직접 접하고 사용해본 뒤에 의사를 결정하기 때문에 부수적인 내용들은 오히려 광고를 위한 목적으로 느껴져 읽지 않게 되고 그냥 넘겨버리게 됩니다. <br><br> 따라서 장점만 간출하게 추려 사이트에 녹여 내고 App에 사용한 디자인적 센스를 녹여낸 사이트를 만드는 것이 가장 좋은 사이트가 아닐까 하고 생각하게 되었습니다.
